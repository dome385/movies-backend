...
func (m *PostgresDBRepo) OneMovie(id int) (*models.Movie, error) {
	...
	// queryrowcontext bei einem erwarteten ergebnis in diesem beispiel soll nur ein film zurückgegeben werden
	...
	// querycontext bei mögliche mehreren objekten, in diesem beispiel können ein film mehrere genres haben
